...
var theme = "default"; // options: default | fc
...
function UpdateLink() {
  ...
  LinkUrl += "&theme=" + inputFieldElements.theme.value;
...
function draw() {
  ...
  textSize(20);
  text(
    "Tippe um die Zeiteinheit" + responsive1 + " zu ändern",
    width / 2,
    height / 1.1
  );
}
